...
public class DeleteServlet extends HttpServlet
{
  ...
  @Resource(mappedName = "jms/GlassFishBookConnectionFactory")
    ...
    @Resource(mappedName = "jms/GlassFishDeleteQueue")
    private Queue queue;
...
"				<div id=\"content\">\n" +
"					<div class=\"post\">\n" +
"						<h2 class=\"title\">Delete File </h2>\n" +
"						<div class=\"entry\">\n" +
"							<p>\n" +
"");
           
Connection connection = connectionFactory.createConnection();
           Session session12 = connection.createSession(false, Session.AUTO_ACKNOWLEDGE);
           MessageProducer messageProducer = session12.createProducer(queue);
           TextMessage filetxt = session12.createTextMessage();
           String filename=request.getParameter("filename1");
           
           filetxt.setText(filename);
           pw.println("Filename is:"+filename);
           messageProducer.send(filetxt);
           System.out.println("File name sent to delete queue at"+new Date());
           messageProducer.close();
           session12.close();
           connection.close();
            pw.println("<br>Delete Start Time:"+new Date());
           pw.println("<br>Delete End Time "+new Date());
                  //  pw.println("<br>Upload End Time:"+new Date());
                pw.println("<br><br>Your File is  Deleted");
                pw.println("                                                        </p>\n" +
"						</div>\n" +
"					</div>\n" +
