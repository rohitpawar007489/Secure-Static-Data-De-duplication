 ...
 * @author Om
 */
@WebServlet(name = "PaperPublicationServlet", urlPatterns =
{
    "/PaperPublication"
})
public class PaperPublicationServlet extends HttpServlet
{
...
"				<div id=\"content\">\n" +
"						<div class=\"post\">\n" +
"						<h2 class=\"title\">Paper Publication </h2>\n" +
"						<div class=\"entry\">\n" +
"							<p><img src=\"images/paper.jpg\" width=\"143\" height=\"143\" alt=\"\" class=\"alignleft border\" /><strong>Title:</strong>Secure Static Data De-Duplication.<br>Paper presented in 4th international conference on Computer Science and Information Technology(ICCIT 2015),Goa.<br><strong>Organized by:</strong><br>Technical Research Organisation ,India. \n"+
"                     <br><a href=\"http://www.troindia.in/\" target=\"_blank\">www.troindia.in</a><br><a href=\"dedup_paper.pdf\" target=\"_blank\">View Paper</a><br></p>\n" +
"							\n" +
"						</div>\n" +
"					</div>\n" +
